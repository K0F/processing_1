...
Veškerá dokumentace je v angličtině včetně webových fór i dalších knih o programování. Nemáte-li problém s jazykem míst k zdokonalování se v Processingu bude vždy dostatek.

\oddil{Knihy}

Ano, jednu z nich držíte v ruce. V minulosti vyšlo bezmála desítka podobných knih na toto téma. Jsou bezesporu obsáhlejší než jaké tato kniha měla kdy v úmyslu. Mezi všemi doporučují nejvíce původní knihu od samotných tvůrců Processingu Casey Rease a Bena Frye nazvanou {\em Processing: A Programming Handbook for Visual Designers and Artists}.

Dále kniha Daniela Shiffmana {\em Learning Processing: A Beginner's Guide to Programming Images, Animation, and Interaction} je jednou z velmi podrobně napsaných knich o Processingu.

Knihy se dají opatřit a rozhodně bych to doporučoval všem kteří potřebují mít opravdu dobrou dokumentaci vždy při ruce. V neposlední řadě bych také upozornil na to, že koupí knihy podporujete tvůrce svobodného softwaru, a tím potažmo i svobodný software jako takový.

\oddil{Experiment}

Nejdůležitějším zdrojem vašich vlastních zkušeností bude vždy samotné experimentování s programováním. Na tuto část kladu největší důraz a v průběhu této knihy to i několikrát zopakuji, je vždy dobré odložit knihy a reference a pustit se do neznámých vod, zkušenost kterou takto naberete, bude vždy ta nejhodnotnější. Nebojte se sami experimentovat.
...
Prvním důvodem je jednoduchost směrem k uživateli, Processing se snaží začátečníky co nejméně zatížit zbytečnými informacemi. Processing prezentuje programování jako přístupnou a ovládnutelnou schopnost. Processing toho dosahuje především rychlou odezvou vizuálního prostředí. Jednoduše řečeno v momentu kdy spustíme kód vidíme okamžitě jeho vizuální výsledek. Taková ilustrativnost je v začátcích téměř nezbytná.

Processing lze velmi krátkým kódem programovat sofistikované programy. Pro příklad zde uvedu soutěž nazvanou {\em Tiny Sketch} portály Rhizome.org a Openprocessing.org. Processing dokáže být natolik úsporný že za pomoci maximálně dvouseti znaků, zde tvůrci byli schopni naprogramovat svébytné programy.


\begin{center}
\includegraphics[width = 1.0\textwidth]{imgs/tinysketch.png}
\end{center}
...
\oddil{Nedostatky Processingu}

Processing byl v minulosti nejvíce kritizován pro samotnou aplikaci vývojového prostředí, která se přes úsilí vývojářů stále nedá označit za bezchybnou. Editor je dost pomalý a některé jeho funkce jako chybová hlášení nefungují zrovna nejlépe. I když si s prostředím zpočátku dokonale vystačíme, pro rozsáhlejší projekty bych sám doporučil využívat Processing i v jiných prostředích (NetBeans, Eclipse, Vim atp.). Samotný Processing lze implementovat téměř kamkoli, kde se dá vyvíjet jazyk Java.
...
y += (mouseY - y) * rychlost; 
\end{lstlisting}
K prmoěným {\em x} a {\em y} přiřazujeme zlomek rozdílu mezi pozicí kurzoru a proměnou v obou osách. Tuto formuli lze využít téměř kdekoli, například při jemném přechodu barev a vyhlazování hodnot obecně.
