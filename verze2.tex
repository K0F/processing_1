...
\section{Základní pravidla a zvyklosti}
...
V problematice programování obecně platí, že není nic složitějšího, než číst cizí kód, nebo dokonce vlastní s odstupem času. Při programování se lidská mysl dostává do stavu mimořádné bdělosti tzv. \slovnik{flow}, stavu ve kterém mysl vědomě drží celý\footnote{nebo větší části} programu.
