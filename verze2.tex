...
Tento pohyb je velmi názorný ukazuje že hodnota z počtu vykreslených okének lze použít jako hodnotu kdekoli. Steně tak si můžeme založit i vlastní proměnnou která bude mít tu samou funcki.
...
\end{lstlisting}
 ...
 je to jedna ze základních proměnných Processingu, pomocí které lze například časovat animace.\footnote{Existují i jiné zápisy například pomocí výrazu millis ... [doplnit]}
