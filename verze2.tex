...
\documentclass[10pt,twopage]{book}
...
Čtete-li knihu z jiných důvodů, než z důvodu učení se programovacímu jazyků, pokusím se text knihy proložit poznatky nabytými moji několikaletou zkušeností sdílení života se \gls{stroj}i.
...
\begin{lstlisting}
/**
* Text v šedém rámování bude značit samotný strojový kód,
...
\item
{\em CONTROL + T} --- klávesové zktatky, psané pomocí velkých písmen a kurzívou.

\item
\textbf{Processing}\index{Processing} --- Indexované pojmy a jmenné názvy vysvětlené přímo v textu, registrované v \textbf{Indexu}\index{index} na konci knihy. Tučně bude vždy označen název tam kde je vysvětlován.
...
\item
Jazyk musíme umět přisbůsobit tomu, aby informoval, sdělil jistou skutečnost - myšlenku sdělovanému subjektu.
