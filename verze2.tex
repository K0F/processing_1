...
Následující text bude podléhat určitým zákonitostem. V knize se objeví několik typů textu, které budou vždy odlišeny stylem zápisu. Rozdělění je následující:

\begin{itemize}

\item
Obyčejný text je člověku srozumitelný popis.
...
\item
Indexované výrazy\index{výraz} budou vždy znamenat výrazy, jejichž definici můžete nalézt ve jmenném rejstříku.
