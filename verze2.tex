...
\setmainfont{Nimbus Roman No9 L} % set the main body font (\textrm), assumes Charis SIL is installed
...
\begin{center}
\includegraphics[scale = 1]{buttons.png}
\end{center}
...
\begin{center}
\includegraphics[scale = 0.75]{editor.png}
\end{center}
...
\begin{center}
\includegraphics[scale = 1]{grid2d.png}
\end{center}
...
\begin{center}
\includegraphics[scale = 1]{gridRect2d.png}
\end{center}
