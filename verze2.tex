...
\newcommand{\klavesy}[1]{\textsuperscript{\em #1}}

\newcommand{\slovnik}[1]{\textbf{\gls{#1}}}
\newcommand{\Slovnik}[1]{\textbf{\Gls{#1}}}
\newcommand{\slovnikpl}[1]{\textbf{\glspl{#1}}}
\newcommand{\Slovnikpl}[1]{\textbf{\Glspl{#1}}}

\newcommand{\vyraz}[1]{\textit{\gls{#1}}}
...
Text je řazený do jednotlivých  kapitol\ref{obsah} a dále stromově do dvou úrovní podkapitol. Pořadí kapitol by mělo odpovídat sledu potřebných informací nezbytných k naučení se programovacímu jazyku Processing.

Pořadí a obsah jednotlivých kapitol vychází jednak ze mé vlastní zkušenosti s učením se, a zároveň z veliké míry koresponduje s podobnými oficiálními průvodci psanými tvůrci a komunitou kolem programovacího jazyka Processing.
...
\subsection{Pravidla formátování}
...
\item
Obyčejný text --- člověku srozumitelný popis ve formě klasického textu.
...
\item
\klavesy{CONTROL + T} --- klávesové zkratky, psané pomocí ``superscriptu``

\item
\vyraz{boolean} --- jednotlivé příkazy a oficiální názvy v textu, zařazené do slovníku, psané ``kurzívou``

\item
\Slovnikpl{výraz ve slovníku} --- ostatní výrazy, jejichž definici můžete nalézt ve slovníku na konci  knihy.
...
\item
Kontrolní otázky \otazka{Jakou barvu má bublina značící otázku?} v textu.
