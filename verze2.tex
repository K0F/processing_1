...
A rozhodně pak knihu Daniela Shiffmana {\em Learning Processing: A Beginner's Guide to Programming Images, Animation, and Interaction} je jednou z velmi podrobně napsaných knich o Processingu.
...
V našem příkladě se jedná o druhou větev podmínky, ta sice není povinná ale pro ukázku jsem ji zde rovnou zmínil. Tedy za ukončením \vyraz{if} a složených závorek můžeme dále slovem \vyraz{else}, tzn. "jestliže ne", řící co se stane v případě nenaplnění naší podmínky.
...
Tímto jsme si definovali naši propisku. Než si ukážeme jak ji použít vysvětleme si některé nejasnosti. Třída se definuje pomocí slova \vyraz{class}, za ním následuje název třídy, v našem případě \vyraz{Propiska}.

Uvnitř složených závorek, které vymezují definici nyní můžeme nastavit potřebné vlastnosti, proměnné. Následuje takzvaný konstruktor. Konstruktor není povinný ale pro ilustraci jej zde uvádím. Konstruktor se nám bude hodit později, kdy budeme chtít vytvořit naší propisku připravenou k práci.

Konstruktor je místo, kde můžeme do nově vznikajícího objektu zaslat počáteční informace. Budu-li například potřebovat dvě propisky, jednu červenou a druhou modrou. Mohu je vytvořit následujícím způsobem.
...
\pododdil{Pokročilejší operace se String}
