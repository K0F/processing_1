...
tato kniha by Vás měla povzbudit v nesnadné úloze osvojení si vašeho prvního programovacího jazyka. Autor této knihy předpokládá Vaše malé nebo dokonce žádné zkušenosti s programováním. Celá kniha by vás měla postupně provázet touto dramatickou zkušností postupného ovládání stroje od základních výpočetních operací k pokročilejším.
...
Proměnlivost je nezbytnou součástí animace. Rozpohybovat lze hodnoty, a tím například jevy, které se v programu zobrazují. Pohyb je proměna stavu v čase.
