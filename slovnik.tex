...
\newglossaryentry{color()}{
	name={color()},
	description={Vytváří barvu ve speciálním datatypu {\em color}. Vstupní hodnoty jsou intepretovány jako  RGB (červená, zelená, modrá) nebo HSB (odstín, sytost, jas) hodnoty. Módy vytváření barev lze přepínat funkcí \vyraz{colorMode()}. Ve výchozím nastavení mají bavy rozmezí 256 odstínu šedi (0..255).}
}
