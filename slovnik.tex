...
{
  name={void},
  description={jedná se o tzv. funkci, je to blok kódu spuštěný jedním slovem, obecně funkce slouží k organizaci která, void anlgicky \uv{prázdno} nevrací zpět žádný výsledek, pouze spouští sérii zadaných příkazů}
}
